...
import inspiringStyles from '~/styles/inspiring.css?url';
  ...
  return (
    <ThemeContext.Provider value={[theme, setTheme]}>
      <html lang="en">
        ...
        <body className="background overflow-hidden text-primary font-sans transition duration-500 overflow-y-auto">
